...
using static WiClass.Class.clsMenuColor;

//==============================================================
//  作者：Tony
//  时间：2017年11月07日
//  文件名：clsMyMenuRender.cs
//  版本：Ver1.0.0  
//  说明：菜单渲染类
//  修改者：***
//  修改说明：***
...
{
    class clsMyMenuRender: ToolStripProfessionalRenderer
    {
        ...
        {
            e.ArrowColor = Color.FromArgb(81,81,81);//设置为红色，当然还可以 画出各种形状  
